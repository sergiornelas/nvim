...
vim.api.nvim_create_autocmd("LspAttach", {
	...
	callback = function(ev)
		...
		keymap("i", "<c-g><c-s>", lsp.signature_help, opts) -- (vim: display current file name and position, toggle between Visual mode and Select mode)
		...
		keymap(
			{ "n", "x", "i" },
			"<c-g><c-i>",
			function() -- (vim: display current file name and position, toggle between Visual mode and Select mode)
