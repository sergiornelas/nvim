...
return {
	...
	config = function()
		...
		map("n", "<leader>fe", function() -- install fd
		...
		map("n", "<leader>gs", "<cmd>lua Snacks.picker.git_diff({layout = 'ivy_split'})<cr>")
		...
		map("n", "<leader>fz", "<cmd>lua Snacks.picker.lazy({search = ''})<cr>")
		...
		map("n", "<leader>ly", "<cmd>lua Snacks.picker.lsp_symbols({ layout = 'sidebar' })<cr>")
